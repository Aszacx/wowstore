<?php /* Smarty version Smarty-3.1.14, created on 2015-05-02 13:04:25
         compiled from "/homepages/15/d548348874/htdocs/wowstore/prestashop/themes/leoconv/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:951770772554502f5dcc278-24860615%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5fb441d3565c699690a1502673c46e27d6685d5e' => 
    array (
      0 => '/homepages/15/d548348874/htdocs/wowstore/prestashop/themes/leoconv/shopping-cart.tpl',
      1 => 1430587682,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '951770772554502f5dcc278-24860615',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_554502f63a0265_01346544',
  'variables' => 
  array (
    'account_created' => 0,
    'empty' => 0,
...
<?php if ($_valid && !is_callable('content_554502f63a0265_01346544')) {function content_554502f63a0265_01346544($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/homepages/15/d548348874/htdocs/wowstore/prestashop/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php }?>" class="button exclusive btn standard-checkout" title="<?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
 &raquo;</a>
		<?php if (Configuration::get('PS_ALLOW_MULTISHIPPING')){?>
			<a href="<?php if ($_smarty_tpl->tpl_vars['back']->value){?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1&amp;back={$back}');?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1');?>
<?php }?>&amp;multi-shipping=1" class="multishipping-button multishipping-checkout exclusive btn button" title="<?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
 &raquo;</a>
		<?php }?>
	<?php }?>
...
<?php }?>" class="button_large btn" title="<?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
