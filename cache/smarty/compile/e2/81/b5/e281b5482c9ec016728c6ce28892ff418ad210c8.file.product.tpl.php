<?php /* Smarty version Smarty-3.1.14, created on 2015-05-02 12:04:33
         compiled from "/homepages/15/d548348874/htdocs/wowstore/prestashop/themes/leoconv/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1675869116554503a1889418-66148859%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e281b5482c9ec016728c6ce28892ff418ad210c8' => 
    array (
      0 => '/homepages/15/d548348874/htdocs/wowstore/prestashop/themes/leoconv/product.tpl',
      1 => 1430584651,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1675869116554503a1889418-66148859',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_554503a2110714_86660221',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_554503a2110714_86660221')) {function content_554503a2110714_86660221($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/homepages/15/d548348874/htdocs/wowstore/prestashop/tools/smarty/plugins/modifier.escape.php';
if (!is_callable('smarty_modifier_date_format')) include '/homepages/15/d548348874/htdocs/wowstore/prestashop/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/homepages/15/d548348874/htdocs/wowstore/prestashop/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/homepages/15/d548348874/htdocs/wowstore/prestashop/tools/smarty/plugins/function.counter.php';
?>
...
<?php }?>
			...
			<div id="short_description_block">
				...
				<p class="buttons_bottom_block">
					<a href="javascript:{}" class="button"><?php echo smartyTranslate(array('s'=>'More details'),$_smarty_tpl);?>
</a>
				</p>
				<?php }?>
...
"  />
				...
				<div id="views_block" class="<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)<2){?>hidden<?php }?>">
					<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>3){?><span class="view_scroll_spacer "><a id="view_scroll_left" class="icon-angle-up" title="<?php echo smartyTranslate(array('s'=>'Other views'),$_smarty_tpl);?>
" href="javascript:{}">&nbsp;</a></span><?php }?>
					<div id="thumbs_list">
...
"  />
						...
						<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>3){?><a id="view_scroll_right" class="icon-angle-down" title="<?php echo smartyTranslate(array('s'=>'Other views'),$_smarty_tpl);?>
" href="javascript:{}">&nbsp;</a><?php }?>
					<?php }?>
				</div> 
			</div>
...
?>
						...
						<?php if ($_smarty_tpl->tpl_vars['accessory']->iteration%3==1){?>
						  <div class="row-fluid">
						<?php }?>
						...
						<?php if (($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity_all_versions']>0||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)){?>
							...
							<div class="p-item span4 product_block ajax_block_product<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['first']){?> first_item<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['last']){?> last_item<?php }else{ ?> item<?php }?> product_accessories_description">
...
" class="product_image">
										<img src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['accessory']->value['link_rewrite'],$_smarty_tpl->tpl_vars['accessory']->value['id_image'],'home_default');?>
...
"   />
									...
									<h5 class="s_title_block">
										<a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['accessoryLink']->value, 'htmlall', 'UTF-8');?>
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['name'], ENT_QUOTES, 'UTF-8', true),25,'...',true);?>
</a>
									</h5>

									<div class="product_desc">
										<div class="block_description">
											<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['accessory']->value['description_short']),60,'...');?>
									...
									<div class="price-cart">
										...
										<a class="exclusive button ajax_add_to_cart_button  btn" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['accessory']->value['id_product']);?>
...
"><?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
						...
						<?php if (($_smarty_tpl->tpl_vars['accessory']->iteration%3==0||$_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['last'])){?>
							</div>
						<?php }?>
...
loader.gif" alt="loader" /></span>
			...
			<p class="clear required"><sup>* <?php echo smartyTranslate(array('s'=>'Required field'),$_smarty_tpl);?>
</sup></p>
		</div>
	<?php }?>
