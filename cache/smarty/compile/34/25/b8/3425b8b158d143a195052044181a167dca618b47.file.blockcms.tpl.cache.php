<?php /* Smarty version Smarty-3.1.14, created on 2015-05-02 01:21:14
         compiled from "/homepages/15/d548348874/htdocs/wowstore/prestashop/themes/prestadesigner_fragrance_shop/modules/blockcms/blockcms.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12553380755446a4731e204-39408609%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3425b8b158d143a195052044181a167dca618b47' => 
    array (
      0 => '/homepages/15/d548348874/htdocs/wowstore/prestashop/themes/prestadesigner_fragrance_shop/modules/blockcms/blockcms.tpl',
      1 => 1430547470,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12553380755446a4731e204-39408609',
  'function' => 
  array (
  ),
  'cache_lifetime' => 31536000,
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_55446a473c39f1_27818688',
  'variables' => 
  array (
    'block' => 0,
    'cms_titles' => 0,
...
<?php if ($_valid && !is_callable('content_55446a473c39f1_27818688')) {function content_55446a473c39f1_27818688($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/homepages/15/d548348874/htdocs/wowstore/prestashop/tools/smarty/plugins/modifier.escape.php';
?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cms_page']->value['meta_title'], 'html', 'UTF-8');?>
				...
				<?php } ?>
				<?php if ($_smarty_tpl->tpl_vars['cms_title']->value['display_store']){?><li><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('stores.php');?>
...
<?php }else{ ?>
	...
	<div class="block_various_links" id="block_various_links_footer">
		<h4><?php echo smartyTranslate(array('s'=>'Informations','mod'=>'blockcms'),$_smarty_tpl);?>
</h4>
		<ul>
			<!-- <?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?><li class="first_item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('prices-drop.php');?>
...
"><?php echo smartyTranslate(array('s'=>'Specials','mod'=>'blockcms'),$_smarty_tpl);?>
			...
			<li class="<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>first_<?php }?>item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('new-products.php');?>
...
"><?php echo smartyTranslate(array('s'=>'New products','mod'=>'blockcms'),$_smarty_tpl);?>
			...
			<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?><li class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('best-sales.php');?>
...
"><?php echo smartyTranslate(array('s'=>'Top sellers','mod'=>'blockcms'),$_smarty_tpl);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['display_stores_footer']->value){?><li class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('stores.php');?>
" title="<?php echo smartyTranslate(array('s'=>'Our stores','mod'=>'blockcms'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Our stores','mod'=>'blockcms'),$_smarty_tpl);?>
</a></li><?php }?>
