<?php /* Smarty version Smarty-3.1.14, created on 2015-05-02 01:10:14
         compiled from "/homepages/15/d548348874/htdocs/wowstore/prestashop/modules/blockcart2/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18828437255446a46b253c1-20949121%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8361c658ab447dbfeec6326d5486bf07b781ea82' => 
    array (
      0 => '/homepages/15/d548348874/htdocs/wowstore/prestashop/modules/blockcart2/blockcart.tpl',
      1 => 1430546887,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18828437255446a46b253c1-20949121',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55446a46d1d603_32707051',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55446a46d1d603_32707051')) {function content_55446a46d1d603_32707051($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/homepages/15/d548348874/htdocs/wowstore/prestashop/tools/smarty/plugins/modifier.escape.php';
...
"><?php echo smartyTranslate(array('s'=>'Cart','mod'=>'blockcart'),$_smarty_tpl);?>
	...
	<div id="cart_block_summary" class="<?php if (isset($_smarty_tpl->tpl_vars['colapseExpandStatus']->value)&&$_smarty_tpl->tpl_vars['colapseExpandStatus']->value=='expanded'||!$_smarty_tpl->tpl_vars['ajax_allowed']->value||!isset($_smarty_tpl->tpl_vars['colapseExpandStatus']->value)){?>collapsed<?php }else{ ?>expanded<?php }?>">
		...
		<span class="ajax_cart_total" <?php if ($_smarty_tpl->tpl_vars['cart_qties']->value<=0){?>style="display:none"<?php }?>><?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value==1){?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['cart']->value->getOrderTotal(false)),$_smarty_tpl);?>
